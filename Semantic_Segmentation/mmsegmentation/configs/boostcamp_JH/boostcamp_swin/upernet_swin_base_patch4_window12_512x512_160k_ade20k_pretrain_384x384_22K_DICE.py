_base_ = [
    '../_base_/models/upernet_swin_diceloss.py', 'swin_dataset.py',
...
log_config = dict(
    ...
    hooks=[
        ...
        dict(type="WandbLoggerHook", init_kwargs=dict(project="Naver_Segmentation", name="Swin-B_DICELOSS_test_JH")),
    ],
)