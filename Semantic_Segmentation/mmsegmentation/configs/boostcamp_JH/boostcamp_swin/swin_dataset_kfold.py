...
data_root = '/opt/ml/segmentation/input/mmseg_kfold/'
...
data = dict(
    ...
    train=dict(
        ...
        img_dir=data_root + "images/train0_all",
        ann_dir=data_root + "annotations/train0_all",
    ...
    val=dict(
        ...
        type=dataset_type,
        reduce_zero_label=False,
        img_dir=data_root + "images/val0_all",
        ann_dir=data_root + "annotations/val0_all",
