...
data = dict(
    ...
    train=dict(
        ...
        img_dir='/opt/ml/segmentation/input/mmseg/images/train3',
        ann_dir='/opt/ml/segmentation/input/mmseg/annotations/train3',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations'),
            dict(type='Resize', img_scale=(512, 512), ratio_range=(0.5, 2.0)),
    ...
    val=dict(
        ...
        type='CustomDataset',
        reduce_zero_label=False,
        img_dir='/opt/ml/segmentation/input/mmseg/images/val3',
        ann_dir='/opt/ml/segmentation/input/mmseg/annotations/val3',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipAug',
...
log_config = dict(
    ...
    hooks=[
        ...
        dict(
            ...
            init_kwargs=dict(
                project='Naver_Segmentation', name='Swin-B_kfold_number_3_hs'))
    ])
...
work_dir = './work_dirs/Swin_Kfold_3'
gpu_ids = range(0, 1)
