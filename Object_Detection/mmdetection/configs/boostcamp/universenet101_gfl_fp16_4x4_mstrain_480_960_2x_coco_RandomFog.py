...
_base_ = [
    ...
    'config/dataset_mstrain_480_960_RandomFog.py',
...
log_config = dict(
    ...
    hooks=[
        ...
        dict(type="WandbLoggerHook", init_kwargs=dict(project="recycle_trash_OD", name="universenet101_gfl_fp16_4x4_mstrain_480_960_2x_coco_RandomFog")),
    ],
)